...
import { retryWithBackoff, isRetryable } from '../utils/retryUtils';
 ...
 * Throws on API/network errors so the caller can handle them.
 */
...
- Use null (not the string "null") for genuinely missing vendor/date/total` },
    ...
    { maxAttempts: 3, baseDelayMs: 1000, shouldRetry: isRetryable }
  );

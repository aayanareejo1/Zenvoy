    ...
    return (
      <View style={[styles.container, styles.center]}>
        ...
        <View style={styles.benefits}>
          {['☁️  Automatic cloud backup', '📱  Restore on new device', '📊  Pro reports & CSV export', '♾️  Unlimited scans'].map(b => (
      ...
      <Modal visible={showModal} transparent animationType="slide">
        <View style={styles.modalOverlay}>
          <View style={styles.modal}>
            ...
            {[
              { label: 'Monthly', price: 'TBD/mo', id: 'monthly' },
              { label: 'Yearly', price: 'TBD/yr', id: 'yearly' },
            ].map(plan => (
              <TouchableOpacity key={plan.id} style={styles.planBtn} onPress={() => Alert.alert('Coming Soon', 'IAP setup pending.')}>
